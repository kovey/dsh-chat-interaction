 ...
 */
import type { ButtonSpec, CardSpec, ChannelCapabilities, ChannelDescriptor, InboundMessage, ListenerStatus, SendResult } from './types.js';
...
export declare function descriptorOf(adapter: ChannelAdapter): ChannelDescriptor;
