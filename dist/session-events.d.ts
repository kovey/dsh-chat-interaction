 ...
 */
export declare function readSessionEvents(session: SessionEventsSource | null | undefined): SessionEventLike[];
/** Whether the session exposes an event log at all (either API generation). */
export declare function hasSessionEvents(session: SessionEventsSource | null | undefined): boolean;
